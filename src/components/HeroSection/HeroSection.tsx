            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="w-1480 h-674 mt-2 flex items-center justify-between gap-x-20 w-9/12">
                <div className="flex flex-col gap-y-5">
                    ...
                    <div className="ml-2 flex gap-x-6 mt-6">
                        ...
                        <button className="max-2xl:px-1 border-2 border-solid border-black rounded-lg max-sm:px-2 px-4 font-medium hover:bg-black hover:text-white transition duration-300 ease-in-out max-sm:text-[sm]">Contate-nos</button>
                    </div>
                </div>
