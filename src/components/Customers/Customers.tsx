    ...
    return(
        <>
            <div id='customers' className='bg-gray-customer-background px-4 py-12 flex flex-col items-center justify-center mt-16 w-screen'>
                ...
                <div className='flex flex-wrap mt-12 mb-12 gap-x-4 gap-y-4 items-center justify-center w-[1497px] max-sm:flex-col'>
                    <div data-aos="flip-left" data-aos-duration="2000" className='w-480 h-20 bg-gray-customer flex gap-x-4 px-6 items-center rounded-lg max-sm:w-[310px]'>
